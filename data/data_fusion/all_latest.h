...
#ifndef _RCMW_DATA_DATA_FUSION_ALL_LATEST_H_
#define _RCMW_DATA_DATA_FUSION_ALL_LATEST_H_
...
/**
 * @brief 数据融合，buffer_m0_在fill时触发该融合函数，将4个数据进行融合
 */
...
public:
    AllLatest(const ChannelBuffer<M0>& buffer_0, const ChannelBuffer<M1>& buffer_1, 
              const ChannelBuffer<M0>& buffer_2, const ChannelBuffer<M1>& buffer_3) : 
              buffer_m0_(buffer_0), buffer_m1_(buffer_1), 
              buffer_m2_(buffer_2), buffer_m3_(buffer_3), 
...
/**
 * @brief 模板偏特化:数据融合，buffer_m0_在fill时触发该融合函数，将3个数据进行融合
 */
...
public:
    AllLatest(const ChannelBuffer<M0>& buffer_0, const ChannelBuffer<M1>& buffer_1, 
              const ChannelBuffer<M0>& buffer_2) : 
              buffer_m0_(buffer_0), buffer_m1_(buffer_1), 
              buffer_m2_(buffer_2), 
              buffer_fusion_(buffer_m0_.channel_id(), 
                new CacheBuffer<std::shared_ptr<FusionDataType>>(
...
/**
 * @brief 模板偏特化:数据融合，buffer_m0_在fill时触发该融合函数，将2个数据进行融合
 */
