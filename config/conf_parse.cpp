...
bool GetRcmwConfFromFile(const std::string& file_path, RcmwConfig* config) {
    if(config == nullptr) {
        AERROR << "Error: RcmwConfig pointer is null.";
        return false;
    }
...
void from_json(const json& j, RcmwConfig& cmw_config) {
