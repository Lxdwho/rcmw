...
#ifndef _RCMW_NODE_NODE_CHANNEL_IMPL_H_
#define _RCMW_NODE_NODE_CHANNEL_IMPL_H_
...
auto NodeChannelImpl::CreateSubscriber(const SubscriberConfig& config,
    ...
    return this->template CreateSubscriber<MessageT>(role_attr, reader_func, config.pending_queue_size);
}
...
auto NodeChannelImpl::CreateSubscriber(const RoleAttributes& role_attr,
    ...
    subscriber_ptr = std::make_shared<Subscriber<MessageT>>(
