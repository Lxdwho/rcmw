...
#ifndef _DISCOVERY_MUTIL_VALUE_WAREHOUSE_H_
#define _DISCOVERY_MUTIL_VALUE_WAREHOUSE_H_
...
class MutilValueWarehouse : public WarehouseBase {
public:
    ...
    bool Search(uint64_t key, std::vector<RoleAttributes>* matched_roles_attr) override;

    bool Search(const RoleAttributes& target_attr) override;
    bool Search(const RoleAttributes& target_attr,  RolePtr* first_matched) override;
    bool Search(const RoleAttributes& target_attr, RoleAttributes* first_matched_role_attr) override;

    bool Search(const RoleAttributes& target_attr, std::vector<RolePtr>* matched_roles) override;
    bool Search(const RoleAttributes& target_attr, std::vector<RoleAttributes>* matched_roles_attr) override;
